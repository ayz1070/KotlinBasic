// 기억 장소은 리터럴 작성 문법에 맞춰서 값을 작성하면 작성한 값을 저장하기 위해
// 기억 장소가 만들어 진다.
// 이 때, 위치는 VM이 알아서 정해주고 용도와 크기는 작성해준 값의 문법을 보고 결정해준다.
// 이러한 값들은 프로그램 실행 중엔 변경될 수가 없다.
// 만약 프로그램 실행 중에 어떠한 의미의 값이 변한다면 기억장소를 개발자에 의해 만들고
...
fun main() {
    ...
    // 정수값을 작성하면 4 byte 기억 공간이 만들어지고 저장되기 때문에
